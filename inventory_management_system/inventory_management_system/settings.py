...
SECRET_KEY = 'django-insecure-jdp2%zf-u)f(8&j#@r#yg%6+e=9j5!xcl3!3bp4ixccoe0=0p!'
...
INSTALLED_APPS = [
    ...
    'transactions',  # Custom app for transactions
    'invoice',  # Custom app for invoice management
    'bills',  # Custom app for bill management
